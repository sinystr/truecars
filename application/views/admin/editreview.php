...
<div id="page-heading"><h1>Редактирай ревю</h1></div>
...
<tr>
	...
	<?=validation_errors();?>
			...
			<?=form_open_multipart('admin/reviewedit/'.end($this->uri->segments));?>
		<!-- start id-form -->
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		<tr>
			<th valign="top">Заглавие:</th>
			<td><input type="text" name="title" value="<?=$review['title'];?>"class="inp-form" /></td>
			<td></td>
		</tr>
		...
		<tr>
			...
			<td id="container">
				<?
					...
					$i++;
				?>
				<input class="inp-form" id="field_0" name="features[]" value="<?=$feature;?>" type="text" /><br />
		...
		<tr>
			...
			<td><input type="text" name="video" value="<?=$review['video'];?>" class="inp-form" /></td>
			<td></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><textarea name="content" style="width: 400px; height: 150px;"><?=$review['content'];?></textarea></td>
			<td></td>
		</tr>
