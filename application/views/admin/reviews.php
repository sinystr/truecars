        ...
        <div id="content-table-inner">
            ...
            <div id="table-content">
                ...
                <tr>
                    ...
                    <th class="table-header-repeat line-left"><a href="">Снимка</a></th>
                ...
                <tr>
                    <td><?=$item['title'];?></td>
                    <td><a href=""><img src="<?=base_url().'uploads/pictures/'.$item['main'];?>" width="200"/></a></td>
                    <td class="options-width">
                    <a href="<?=base_url('admin/reviewedit/'.$item['id']);?>" title="Редактирай" class="icon-1 info-tooltip"></a>
                    <a href="<?=base_url('admin/delete/'.$item['id'].'/review');?>" title="Изтрий" class="icon-2 info-tooltip"></a>
                    </td>
                </tr>
                <? 
                    endforeach;
